...
const COLUMNS = [
  ...
  {
    key: 'clientName', label: 'Client Name', defaultWidth: 160, minWidth: 110,
    sortValue: (t) => t.v_tenantname ?? '',
    render: (t) => t.v_tenantname || '—',
  },
  {
