				...
				<table className="w-full text-sm table-fixed border-collapse">
					...
					<tbody className="divide-y divide-gray-100 dark:divide-gray-800">
						{loading ? (
							...
							pagedData.map((row, i) => (
								...
								>
									<td className="px-4 py-3 text-gray-900 dark:text-white whitespace-nowrap border-r border-gray-200 dark:border-gray-800 last:border-r-0 overflow-hidden truncate">{row.v_managername || "N/A"}</td>
									...
									<td className="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap border-r border-gray-200 dark:border-gray-800 last:border-r-0 overflow-hidden truncate">{getRoleValue(row) === "SuperAdmin" ? "Super Admin" : getRoleValue(row) || "User"}</td>
									<td className="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap border-r border-gray-200 dark:border-gray-800 last:border-r-0 overflow-hidden truncate">{row.v_department || "N/A"}</td>
					...
					<tfoot className="border-t border-gray-200 dark:border-gray-800 bg-gray-50/70 dark:bg-gray-800/60">
						<tr className="text-center">
							...
							<td className="px-4 py-3 text-sm font-semibold text-gray-900 dark:text-white border-r border-gray-200 dark:border-gray-800">{filteredTotals.newTickets}</td>
