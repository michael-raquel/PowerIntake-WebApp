          ...
          rows.map((row, i) => (
            <div key={i} className="p-4 space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900 dark:text-white">{row.clientName}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">{row.tenantId}</p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white font-medium">{row.userName}</p>
                </div>
                <div>
            ...
            {rows.length === 0 ? (
              ...
              rows.map((row, i) => (
                <tr key={i} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  <td className="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap">{row.tenantId}</td>
                  <td className="px-4 py-3 text-gray-900 dark:text-white whitespace-nowrap">{row.clientName}</td>
                  <td className="px-4 py-3 text-gray-600 dark:text-gray-300 whitespace-nowrap">{row.userName}</td>
