...
export default function ComApplicationFeedbackUpdate({
	open,
	onClose,
	initialValues = null,
	onSubmit,
	...
	useEffect(() => {
		if (!open) return;
		setClassification(initialValues?.classification || "Compliment");
		setRating(Number.isFinite(initialValues?.rating) ? initialValues.rating : 0);
