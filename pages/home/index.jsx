...
import { ExternalLink, Clock, User, Tag, Building2, ArrowUpRight, Flag, Wrench } from 'lucide-react';
...
export default function HomePage() {
  ...
  const recentTickets = useMemo(() =>
    [...tickets]
      .filter(t => t.v_status !== 'Work Completed' && t.v_status !== 'Problem Solved')
      .sort((a, b) => new Date(b.v_createdat) - new Date(a.v_createdat))
      .slice(0, 5),
    [tickets]
  );
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
          ...
          <div className="p-4 sm:p-6 grid gap-3">
            {recentTickets.map(ticket => (
              <TicketCard key={ticket.v_ticketuuid} ticket={ticket} onClick={handleTicketClick} showOwner={safeActiveTab !== 'my-ticket'} />
            ))}
