...
const COLUMNS = ['Ticket ID', 'Title', 'Category', 'Priority', 'Created', 'Status', 'Days', 'Technician'];

export default function ComTableMyTickets({ currentPage, recordsPerPage, onTotalRecordsChange }) {
