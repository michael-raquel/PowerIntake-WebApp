...
const COLUMNS = [
  'Ticket ID', 'Department', 'User', 'Title',
  'Category', 'Priority', 'Created', 'Status', 'Technician',
];
...
export default function ComTableCompany({
  ...
  const filteredTickets = tickets.filter((t) => {
    ...
    const searchOk =
      ...
      normalize(t.v_department).includes(q) ||
    ...
    return searchOk && managerOk && priorityOk && categoryOk && statusOk;
  });
