...
const COLUMNS = [
  'Ticket ID', 'Manager', 'User', 'Title',
  'Category', 'Priority', 'Created', 'Status',
  'Days', 'Technician',
];
export default function ComTableCompany({ currentPage, recordsPerPage, onTotalRecordsChange }) {
